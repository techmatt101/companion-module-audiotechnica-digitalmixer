...
class atdmInstance extends InstanceBase {
	...
	processResponse(response) {
		...
		switch (category) {
			...
			case 'gopl':
				if(this.DATA.operator_page[parseInt(params[0].toString()) - 1]) {
			...
			// 	console.log('!GOPM!!!!!!!! -------------');
			// 	console.warn('!GOPM!!!!!!!! -------------');
			// 	this.DATA.operator_page[params[0].toString()][`fader_${params[1].toString()}_mute`] = (params[2].toString() == '1' ? true : false);
			// 	break;
